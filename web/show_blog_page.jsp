<%-- 
    ...
    Created on : May 20, 2022, 6:54:52 PM
    Author     : akshay
--%>
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%> || TechBlog by Learn Code with Akshay </title>
    ...
    <%--facebook commment plugin--%>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v14.0" nonce="0LUV2uG9"></script> 
